...
<body>
<div id="topbar">
		<a href="index.php"><div id="logotopbar"></div></a>
...
<h3 id="tituloregistro">Register</h3>
...
Password<input class="form-control" type="password"></input>
...
<a href="index.php"><button class="btn btn-verde"  >Sign in</button></a>
</div>
